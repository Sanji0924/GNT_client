<template>
  <div>
    <div class="banner-nightview banner d-flex align-items-end mb-6">
    ...
    <div>
      <h2 class="text-white mb-3">精選景點</h2>
      <ul class="list-unstyled d-flex">
        <li>
          <a href="#" class="btn btn-outline-primary me-3">全部</a>
        </li>
        <li>
          <a href="#" class="btn btn-outline-primary me-3">散步</a>
        </li>
        <li>
          <a href="#" class="btn btn-outline-primary me-3">拍照</a>
        </li>
        <li>
          <a href="#" class="btn btn-outline-primary">夜市</a>
        </li>
      </ul>
    </div>
    <div class="row">
      <div
        ...
        v-for="nightView in nightViews"
        :key="nightView.ShopID"
      >
        <div class="card border-primary rounded-lg w-100 overflow-hidden">
          <div class="position-relative">
            ...
            <div
              ...
              :style="{ backgroundImage: `url(${nightView.Image1})` }"
            ></div>
          </div>
          <div class="card-body">
            <div
            ...
            <h5 class="card-title fs-5 fw-bold d-flex align-items-center">
              {{ nightView.Name
              }}<span class="fs-6 badge bg-gray ms-2 lh-sm">調酒</span>
            </h5>
...
export default {
  ...
  methods: {
    getNightViews() {
      const api = `https://localhost:44333/api/ShopInfoes/type/viewpoint`;

      this.$http
        .get(api)
        .then((res) => {
          console.log(res);
          this.nightViews = res.data;
        })
        .catch((err) => {
          console.dir(err);
